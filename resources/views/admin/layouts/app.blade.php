    ...
    <div class="sidebar-footer">
        <a href="##" class="sidebar-user">
            <span class="sidebar-user-img">
                <picture><source srcset="/elegant/img/avatar/avatar-illustrated-01.webp" type="image/webp"><img src="./elegant/img/avatar/avatar-illustrated-01.png" alt="User name"></picture>
            </span>
    ...
    <main class="main users chart-page" id="skip-target">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            {{-- <div class="chart">
              <canvas id="myChart" aria-label="Site statistics" role="img" style="display: block; box-sizing: border-box; height: 368px; width: 737px;" width="737" height="368"></canvas>
            </div> --}}
            @yield('content')
          </div>
          {{-- <div class="col-lg-3">
            <article class="customers-wrapper">
              <canvas id="customersChart" aria-label="Customers statistics" role="img" width="232" height="256" style="display: block; box-sizing: border-box; height: 256px; width: 232px;"></canvas>
