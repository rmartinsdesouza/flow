        ...
        <div class="main-nav-start">
            <div class="search-wrapper">
                <form action="{{ route('projects.search') }}" method="post">
                    ...
                    {{-- <input type="text" placeholder="Filtrar..." required=""> --}}
            ...
            <div class="nav-user-wrapper">
                <button href="##" class="nav-user-btn dropdown-btn" title="My profile" type="button">
                    ...
                    <span class="nav-user-img">
                        <picture>
                            <source srcset="./elegant/img/avatar/avatar-illustrated-02.webp" type="image/webp"><img
                                src="./elegant/img/avatar/avatar-illustrated-02.png" alt="User name">
                        </picture>
                    </span>
                </button>
                <ul class="users-item-dropdown nav-user-dropdown dropdown">
                    <li><a href="##">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="feather feather-user" aria-hidden="true">
                    ...
                    <li><a href="##">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="feather feather-settings" aria-hidden="true">
